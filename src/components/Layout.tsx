...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0d1117]">
      ...
      <footer className="py-8 px-6 bg-[#131922] mt-16">
        <div className="container mx-auto">
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="flex gap-6 mb-6">
              <a href="#" className="text-sm text-white/70 hover:text-white transition-colors">Support</a>
          ...
          <div className="text-center">
            <p className="text-sm text-white/50">&copy; {new Date().getFullYear()} Vortex. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </div>
